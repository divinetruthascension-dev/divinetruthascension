...
HTTP_PORT=8080
NETLIFY_SITE="your-netlify-site-name-or-site-id"
...
if command -v netlify >/dev/null 2>&1; then
    echo "Deploying to Netlify site: $NETLIFY_SITE..."
    netlify deploy --prod --dir="$MAIN_REPO" --site="$NETLIFY_SITE"
else
    echo "Netlify CLI not installed. Skipping deployment."
fi
